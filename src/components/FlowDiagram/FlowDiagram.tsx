		...
		<View style={styles.container}>
			<Svg width={SCREEN_WIDTH} style={{ alignSelf: 'center' }} height={maxY - minY + offsetY + Math.round(5 * SCALE)}>
				...
				<G>
					...
					{/* Subtitle */}
					<SvgText x={mainX + MAIN_W / 2} y={mainY + Math.round(46 * SCALE)} fontSize={Math.round(11 * SCALE)} fill="#C0C4CC" textAnchor="middle">MNTL</SvgText>
					{/* Divider */}
					<Path
					...
					<SvgText x={mainX + MAIN_W * 0.28} y={mainY + Math.round(94 * SCALE)} fontSize={Math.round(22 * SCALE)} fill="#22C5FF" fontWeight="700" textAnchor="middle">528.5</SvgText>
					<SvgText x={mainX + MAIN_W * 0.28} y={mainY + Math.round(110 * SCALE)} fontSize={Math.round(12 * SCALE)} fill="#C0C4CC88" textAnchor="middle">m</SvgText>
					{/* CK column */}
					...
					<SvgText x={mainX + MAIN_W * 0.72} y={mainY + Math.round(94 * SCALE)} fontSize={Math.round(22 * SCALE)} fill="#C0C4CC" fontWeight="700" textAnchor="middle">528.0</SvgText>
					<SvgText x={mainX + MAIN_W * 0.72} y={mainY + Math.round(110 * SCALE)} fontSize={Math.round(12 * SCALE)} fill="#C0C4CC88" textAnchor="middle">m</SvgText>
					{/* Indicator circles */}
            ...
            L ${topX + TOP_W - Math.round(12 * SCALE)} ${topY + Math.round(32 * SCALE)}`}
				...
				<G>
					...
					<SvgText x={leftBoxX + SIDE_W / 2} y={leftBoxY + Math.round(24 * SCALE)}
						...
						fill="#ef4444" fontWeight="700" textAnchor="middle">Qxmt</SvgText>
					{/* Divider */}
					<Path
					...
					<SvgText x={leftBoxX + SIDE_W * 0.28} y={leftBoxY + Math.round(74 * SCALE)}
						...
						fill="#ef4444" textAnchor="middle">50</SvgText>
					<SvgText x={leftBoxX + SIDE_W * 0.28} y={leftBoxY + Math.round(92 * SCALE)}
						fontSize={Math.round(12 * SCALE)} fill="#C0C4CC88" textAnchor="middle">m³/s</SvgText>
					{/* CK COLUMN */}
					...
					<SvgText x={leftBoxX + SIDE_W * 0.72} y={leftBoxY + Math.round(74 * SCALE)}
						fontSize={Math.round(26 * SCALE)} fontWeight="700"
						fill="#ffffff" textAnchor="middle">50</SvgText>
				...
				<G>
					...
					<SvgText x={rightBoxX + SIDE_W / 2} y={rightBoxY + Math.round(22 * SCALE)} fontSize={Math.round(16 * SCALE)} fill="#ef4444" fontWeight="700" textAnchor="middle">Qxt</SvgText>
					<Path
					...
					<SvgText x={rightBoxX + SIDE_W * 0.28} y={rightBoxY + Math.round(74 * SCALE)} fontSize={Math.round(26 * SCALE)} fill="#ef4444" fontWeight="700" textAnchor="middle">150</SvgText>
					<SvgText x={rightBoxX + SIDE_W * 0.28} y={rightBoxY + Math.round(92 * SCALE)} fontSize={Math.round(12 * SCALE)} fill="#C0C4CC88" textAnchor="middle">m³/s</SvgText>
					...
					<SvgText x={rightBoxX + SIDE_W * 0.72} y={rightBoxY + Math.round(74 * SCALE)} fontSize={Math.round(26 * SCALE)} fill="#ffffff" fontWeight="700" textAnchor="middle">175</SvgText>
					<SvgText x={rightBoxX + SIDE_W * 0.72} y={rightBoxY + Math.round(92 * SCALE)} fontSize={Math.round(12 * SCALE)} fill="#C0C4CC88" textAnchor="middle">m³/s</SvgText>
				</G>
				...
				<G>
					...
					<SvgText x={bottomX + BOTTOM_W / 2} y={bottomY + Math.round(22 * SCALE)} fontSize={Math.round(16 * SCALE)} fill="#00E676" fontWeight="700" textAnchor="middle">Qcm</SvgText>
					{/* Divider */}
					<Path
					...
					<SvgText x={bottomX + BOTTOM_W * 0.28} y={bottomY + Math.round(74 * SCALE)} fontSize={Math.round(26 * SCALE)} fill="#00E676" fontWeight="700" textAnchor="middle">650</SvgText>
					<SvgText x={bottomX + BOTTOM_W * 0.28} y={bottomY + Math.round(92 * SCALE)} fontSize={Math.round(12 * SCALE)} fill="#C0C4CC88" textAnchor="middle">m³/s</SvgText>
					{/* CK column */}
					...
					<SvgText x={bottomX + BOTTOM_W * 0.72} y={bottomY + Math.round(74 * SCALE)} fontSize={Math.round(26 * SCALE)} fill="#C0C4CC" fontWeight="700" textAnchor="middle">620</SvgText>
					<SvgText x={bottomX + BOTTOM_W * 0.72} y={bottomY + Math.round(92 * SCALE)} fontSize={Math.round(12 * SCALE)} fill="#C0C4CC88" textAnchor="middle">m³/s</SvgText>
				</G>
				</G>
			</Svg>
		</View>
