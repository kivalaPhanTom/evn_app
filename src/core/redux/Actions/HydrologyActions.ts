...
export const getHydrographicChart = createAction<{ companyId: string; type: string }>(
  ACTION_TYPES.GET_HYDROLOGY_GRAPHIC_CHART,
)
export const getHydrologyPlantsParam = createAction<{ currentPlantId?: string }>(
  ACTION_TYPES.GET_HYDROLOGY_PLANTS_PARAM,
)
...
export const getHydrologyPlantsInfo = createAction<{ plantId: string; date: string }>(
  ACTION_TYPES.GET_HYDROLOGY_PLANTS_INFO,
)
export const getPowerStoreInLake = createAction(ACTION_TYPES.GET_POWER_STORE_IN_LAKE)
export const getPowerStoreInLakeFactDetail = createAction<{ currentPlantId: string }>(
  ACTION_TYPES.GET_POWER_STORE_IN_LAKE_FACT_DETAIL,
)
...
export const getUpstreamWaterLevel_2 = createAction<{
  ...
  compareDate: string
  type: string
}>(ACTION_TYPES.GET_UPSTREAM_WATER_LEVEL_2)
export const getUpstreamWaterLevel_3 = createAction<{
  ...
  type: string
}>(ACTION_TYPES.GET_UPSTREAM_WATER_LEVEL_3)
export const getInflow2 = createAction<{
  currentPlantId: string
  currentDate: string
  compareDate: string
  type: string
}>(ACTION_TYPES.GET_INFLOW_2)
export const getInflow3 = createAction<{
  ...
  compareToDate: string
  type: string
}>(ACTION_TYPES.GET_INFLOW_3)
export const getOutflow2 = createAction<{
  currentPlantId: string
  currentDate: string
  compareDate: string
  type: string
}>(ACTION_TYPES.GET_OUTFLOW_2)
export const getOutflow3 = createAction<{
  ...
  compareToDate: string
  type: string
}>(ACTION_TYPES.GET_OUTFLOW_3)
export const getTurbineflow2 = createAction<{
  currentPlantId: string
  currentDate: string
  compareDate: string
  type: string
}>(ACTION_TYPES.GET_TURBINE_FLOW_2)
export const getTurbineflow3 = createAction<{
  ...
  compareToDate: string
  type: string
}>(ACTION_TYPES.GET_TURBINE_FLOW_3)
...
// Dai dien 4 bieu do thuy van bang mot action de Redux chi can cap nhat mot lan.
export const getHydrologyComparison = createAction<HydrologyComparisonPayload>(ACTION_TYPES.GET_HYDROLOGY_COMPARISON)
