...
export const getProductOutputByDays = createAction<{ n: number; samePeriodYear: number }>(
  ACTION_TYPES.GET_PRODUCT_OUTPUT_BY_DAYS,
)
export const getProductCummulativeOutput = createAction<ProductCummulativeOutputParams>(
  ACTION_TYPES.GET_PRODUCT_CUMMULATIVE_OUTPUT,
)
...
export const getProductOutputOverviewFactDetail = createAction<{
  ...
  getDataFromApi: any
  setLoading: any
}>(ACTION_TYPES.GET_PRODUCT_OUTPUT_OVERVIEW_FACT_DETAIL)
export const getProductOutputByHoursFactDetail = createAction<{
  factoryId: string
  getDataFromApi: any
  setLoading: any
}>(ACTION_TYPES.GET_PRODUCT_BY_HOURS_FACT_DETAIL)
...
}>(ACTION_TYPES.GET_PRODUCT_OUTPUT_COMPARE_CHART)
