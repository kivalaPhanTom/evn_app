...
export const { setLoading, setProfitData, setRevenueData, setPowerPrices, setRevenueCostSummary, setProfitFactDetailData, setRevenueFactDetailData } = revenueProfitSlice.actions
