...
function* getTechInfoApi() {
    yield takeEvery(getTechInfo, getTechInfoSaga)
}
function* getTechInfoDetailApi() {
    yield takeEvery(getTechInfoDetail, getTechInfoDetailSaga)
}
export function* techInfoSagaList() {
    yield all([
        getTechInfoApi(),
        getTechInfoDetailApi()
    ])
}
